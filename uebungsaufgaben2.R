...
quartil.mittelwert = mean(quarti)
quartil.median = median(quarti)
quartil.varianz = var(quarti)
quartil.standardabweichung = sd(quarti)
quartil.spannweite = max(quarti) - min(quarti)