...
quarti = c(P1=1,P2=3,P3=4,P4=6,P5=8,P6=10,P7=12,P8=13,P9=15,P10=19,P11=30)
quarti.mittelwert = mean(quarti)
quarti.median = median(quarti)
quarti.varianz = var(quarti)
quarti.standardabweichung = sd(quarti)
quarti.spannweite = max(quarti) - min(quarti)